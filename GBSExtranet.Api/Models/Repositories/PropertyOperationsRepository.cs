        ...
        //    }
            ...
            if (dt.Rows.Count > 0)
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    GBSExtranet.Api.Models.Repositories.FirmRequestsRepository.Encryption64 objEncryptreservation = new GBSExtranet.Api.Models.Repositories.FirmRequestsRepository.Encryption64();
