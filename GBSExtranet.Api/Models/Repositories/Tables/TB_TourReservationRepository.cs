...
{
    public class TB_TourReservationRepository : BaseRepository
    {
        public  string CultureCode = System.Threading.Thread.CurrentThread.CurrentCulture.TwoLetterISOLanguageName;
        public List<TB_TourReservationExt> GetAllTableValue(int TableID)
        {
            List<TB_TourReservationExt> list = new List<TB_TourReservationExt>();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    TB_TourReservationExt model = new TB_TourReservationExt();
    ...
    public class TB_TourReservationExt
    {
