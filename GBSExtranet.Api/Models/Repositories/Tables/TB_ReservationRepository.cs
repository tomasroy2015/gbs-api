...
{
    public class TB_ReservationRepository : BaseRepository
    {
        public  string CultureCode = System.Threading.Thread.CurrentThread.CurrentCulture.TwoLetterISOLanguageName;

        public List<TB_ReservationExt> ReadAll(int TableID)
        {
            List<TB_ReservationExt> list = new List<TB_ReservationExt>();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    TB_ReservationExt PageObj = new TB_ReservationExt();
    ...
    public class TB_ReservationExt
    {
