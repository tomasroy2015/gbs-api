...
{
    public class TB_TransferReservationRepository : BaseRepository
    {
        public  string CultureCode = System.Threading.Thread.CurrentThread.CurrentCulture.TwoLetterISOLanguageName;
        public List<TB_TransferReservationExt> GetAllTableValue(int TableID)
        {
            List<TB_TransferReservationExt> list = new List<TB_TransferReservationExt>();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    TB_TransferReservationExt model = new TB_TransferReservationExt();
    ...
    public class TB_TransferReservationExt
    {
