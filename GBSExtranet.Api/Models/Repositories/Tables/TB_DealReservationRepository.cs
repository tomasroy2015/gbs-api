...
{
    public class TB_DealReservationRepository : BaseRepository
    {
        public string CultureCode = System.Threading.Thread.CurrentThread.CurrentCulture.TwoLetterISOLanguageName;

        public List<TB_DealReservationExt> ReadAll(int TableID)
        {
            List<TB_DealReservationExt> list = new List<TB_DealReservationExt>();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    TB_DealReservationExt model = new TB_DealReservationExt();
    ...
    public class TB_DealReservationExt
    {
