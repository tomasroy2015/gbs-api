...
namespace GBSExtranet.Api.ServiceLayer
{
    public class CommonService : BaseService
    {
        ...
        public List<Status> ReadAllStatus(string Culture)
        {
            //string Culture = "en";

            var statuslist = _db.TB_TypeStatus.ToList();

            // BizUtil.LoadList(Biz_db,Culture,)
        ...
        public List<Title> ReadAllTitles(string Culture)
        {
            //string Culture = "en";

            var titlelist = _db.TB_TypeSalutation.ToList();
