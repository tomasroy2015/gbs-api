<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Confirmation.aspx.cs" Inherits="ActionWebAPI.Email.Confirmation" %>
...
<body>
                ...
                <td colspan="2">
                    <div>
                        <span>
                            ...
                            Please click <a href="http://gdshotels.com/">here</a> to go the website and login.
                        </span>
                    </div>
                </td>
            </tr>
    ...
    <div id="footerContainer" class="footerContent">
        <label class="copyright">
            &copy; 2016 GBS Booking System (version 5.0), All rights reserved.</label>
    </div>
    </form>
</body>
</html>
